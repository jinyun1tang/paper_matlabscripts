function [dat,lon,lat] = heat_analysis_grid(varname,isweighted)
...
ncf2=[mdir,'I1980-2000bgc60N-CN_T2.0_N0.0/',varname,'.I1980-2000bgc60N-CN_T2.0_N0.0.1980-2000.nc'];
ncf3=[mdir,'I1980-2000bgc60N-CN_T2.5_N0.0/',varname,'.I1980-2000bgc60N-CN_T2.5_N0.0.1980-2000.nc'];
ncf4=[mdir,'I1980-2000bgc60N-CN_T3.0_N0.0/',varname,'.I1980-2000bgc60N-CN_T3.0_N0.0.1980-2000.nc'];
ncf5=[mdir,'I1980-2000bgc60N-CN_T3.5_N0.0/',varname,'.I1980-2000bgc60N-CN_T3.5_N0.0.1980-2000.nc'];
ncf6=[mdir,'I1980-2000bgc60N-CN_T4.0_N0.0/',varname,'.I1980-2000bgc60N-CN_T4.0_N0.0.1980-2000.nc'];
...
dat=zeros(size(gpp_ctl_avg,1),size(gpp_ctl_avg,2),size(gpp_ctl_avg,3),6);
dat(:,:,:,1)=gpp_ctl_avg;
dat(:,:,:,2)=gpp_n01_avg;
dat(:,:,:,3)=gpp_n02_avg;
dat(:,:,:,4)=gpp_n03_avg;
