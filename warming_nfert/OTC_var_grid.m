...
titles={'(a)Mean TSOI-10CM GRS warming (K)','(b)STD of TSOI-10CM GRS warming (K)';
    '(a)Mean TG GRS warming (K)','(b)STD of TG GRS warming (K)';
...
if(iscent)
    ...
    ncf2=[mdir,'I1980-2000petbcent_OTC/',varname{kkk},'.I1980-2000petbcent_OTC.1980-2000.nc'];    
else
    ncf1=[mdir,'I1850-2000bgcvrt60N-CN_control/',varname{kkk},'.I1850-2000bgcvrt60N-CN_control.1980-2000.nc'];
    ncf2=[mdir,'I1980-2000bgc60N-CN_OTC/',varname{kkk},'.I1980-2000bgc60N-CN_OTC.1980-2000.nc'];
end
