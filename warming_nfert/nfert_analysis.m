function dat = nfert_analysis(varname,region,isweighted)
...
ncf2=[mdir,'I1980-2000bgc60N-CN_T0.0_N.02/',varname,'.I1980-2000bgc60N-CN_T0.0_N.02.1980-2000.nc'];
ncf3=[mdir,'I1980-2000bgc60N-CN_T0.0_N.1/',varname,'.I1980-2000bgc60N-CN_T0.0_N.1.1980-2000.nc'];
ncf4=[mdir,'I1980-2000bgc60N-CN_T0.0_N.2/',varname,'.I1980-2000bgc60N-CN_T0.0_N.2.1980-2000.nc'];
ncf5=[mdir,'I1980-2000bgc60N-CN_T0.0_N.3/',varname,'.I1980-2000bgc60N-CN_T0.0_N.3.1980-2000.nc'];
ncf6=[mdir,'I1980-2000bgc60N-CN_T0.0_N.4/',varname,'.I1980-2000bgc60N-CN_T0.0_N.4.1980-2000.nc'];
ncf7=[mdir,'I1980-2000bgc60N-CN_T0.0_N.5/',varname,'.I1980-2000bgc60N-CN_T0.0_N.5.1980-2000.nc'];
...
gpp_n06=flux_extract(varname,ncf7,region);
...
for j = 1 : sz1
    if(isweighted)
        ...
        gpp_n06_avg(j,:)=slidew_mean(gpp_n06(j,:),12,w);   
        ...
        gpp_n06_avg(j,:)=slide_mean(gpp_n06(j,:),12);          
    end
end
dat=zeros(size(gpp_ctl_avg,1),size(gpp_ctl_avg,2),7);
dat(:,:,1)=gpp_ctl_avg;
dat(:,:,2)=gpp_n01_avg;
dat(:,:,3)=gpp_n02_avg;
dat(:,:,4)=gpp_n03_avg;
