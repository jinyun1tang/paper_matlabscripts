function dat = heat_vertfld_cent(varname,region,isweighted)
%varname='NEE';
...
gpp_ctl=vertfld_extract(varname,ncf1,region);
gpp_n01=vertfld_extract(varname,ncf2,region);
gpp_n02=vertfld_extract(varname,ncf3,region);
gpp_n03=vertfld_extract(varname,ncf4,region);
gpp_n04=vertfld_extract(varname,ncf5,region);
gpp_n05=vertfld_extract(varname,ncf6,region);
