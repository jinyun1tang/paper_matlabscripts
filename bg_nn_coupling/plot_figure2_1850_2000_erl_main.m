...
dat=load('figure2_txt/er_lat_1991-2000.txt');id=(abs(dat)>1d10);dat(id)=0./0.;lh=reshape(dat,[numel(dat)/6,6]);
...
%
sims_switch=[false,false,false,true,true,true];
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        plot(time,-nee(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
ylim([-300,100]);
xlim([1850,2000]);
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        hdl(nact_sim-kk+1)=plot(lat,gpp(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
ylabel('GPP (gC m^-^2 yr^-1)','FontSize',fontsz);
xlabel('Latitude','FontSize',fontsz);
legend(hdl,'MNL','NUL','PNL');
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        plot(lat,npp(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        plot(lat,lai(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        plot(lat,lh(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
ylabel('Ecosystem respiration (C m^-^2 yr^-^1)','FontSize',fontsz);
xlabel('Latitude','FontSize',fontsz);
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        plot(lat,somc(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        plot(lat,somn(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        plot(lat,vegc(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
...
for jj = 1 : 6
    ...
    if(jj==1)
        ...
        plot(lat,vegn(:,jj),clr{7-jj},'LineWidth',linewd);hold on;
    end
end
