...
hold on;
h5=plot((2:numel(incubator.cumresp_T10C))-1,log(syntop.cres1'.*100),'r','LineWidth',2);
h4=plot(log(incubator.cumresp_T20C.*100./incubator.Ctot),'r--','LineWidth',2);
h6=plot((2:numel(incubator.cumresp_T10C))-1,log(syntop.cres2'.*100),'b','LineWidth',2);
