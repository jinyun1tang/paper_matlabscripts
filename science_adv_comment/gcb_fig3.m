close all;
clear all;
load('n1bot_summary_o100.mat');
load('n1bot_summary_o75.mat');
load('n1top_summary_o100.mat');
load('n1top_summary_o75.mat');
load('Qin_topsoil.mat');
figh=1;
ax=multipanel(figh,3,2,[0.07,0.05],[0.42,0.25],[0.055,0.075]);
