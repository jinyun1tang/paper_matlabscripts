...
save('cent_ncompet_case4.mat','tout11','yout11','tout21','yout21',...
    'tout31','yout31','tout41','yout41','tout51','yout51');
else
    load('cent_ncompet_case4.mat');
end
%Extra.method='';
%Extra.dt=2*1800;
...
ax(1)=subplot(4,1,1);
plot(tout11,yout21(:,vid.minn)-yout11(:,vid.minn),'LineWidth',2);
hold on;
plot(tout11,yout31(:,vid.minn)-yout11(:,vid.minn),'r','LineWidth',2);

ax(2)=subplot(4,1,2);
plot(tout11,yout21(:,vid.minp)-yout11(:,vid.minp),'LineWidth',2);
hold on;
plot(tout11,yout31(:,vid.minp)-yout11(:,vid.minp),'r','LineWidth',2);

ax(3)=subplot(4,1,3);
plot(tout11,sum(yout21(:,vid.lits),2)-sum(yout11(:,vid.lits),2),'LineWidth',2);
hold on;
plot(tout11,sum(yout31(:,vid.lits),2)-sum(yout11(:,vid.lits),2),'r','LineWidth',2);

ax(4)=subplot(4,1,4);
plot(tout11,sum(yout21(:,vid.soms),2)-sum(yout11(:,vid.soms),2),'LineWidth',2);
hold on;
plot(tout11,sum(yout31(:,vid.soms),2)-sum(yout11(:,vid.soms),2),'r','LineWidth',2);
